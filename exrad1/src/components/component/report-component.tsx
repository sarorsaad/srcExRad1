...
export function reportComponent() {
  ...
  return (
    <div className="bg-white">
      <div className="bg-[#bd1e59] p-4 text-white">
        <h1 className="text-2xl font-bold">Reports</h1>
      </div>
      <div className="flex justify-between items-center p-4">
        <div className="flex space-x-2">
          <Button className="bg-[#bd1e59] text-white">Copy</Button>
          <Button className="bg-[#bd1e59] text-white">Excel</Button>
          <Button className="bg-[#bd1e59] text-white">CSV</Button>
          <Button className="bg-[#bd1e59] text-white">PDF</Button>
        </div>
        <div className="flex space-x-2">
